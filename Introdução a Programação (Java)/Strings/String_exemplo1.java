...
ser iniciada com o valor: "Maria da Silva e a segunda deve ser preenchida com
um nome digitado pelo usuário (este nome deve ter no mínimo quatro caracteres).
Em seguida, o programa deve apresentar:
 ...
 */
package string_exemplo1;

import java.util.Scanner;

public class String_exemplo1 {
...
//Se a letra x está presente no nome digitado pelo usuário.
        ...
        if (posX != -1)
            System.out.println("A letra x encontra-se na posição "+posX+" do nome.");
        else
